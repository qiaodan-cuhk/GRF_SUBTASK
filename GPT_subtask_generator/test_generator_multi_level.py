...
def merge_doe_cls(groups, n_agents, role_list, doe_path, merge_doe_name, max_reward_code_path_for_each_group):
    ...
    doe_path: dir - 存储路径  # f'GRF_SUBTASK/doe_epymarl-main/results/gfootball/Time'
...
def train_merge_team(groups,
    ...
    doe_params = {
        ...
        "doe_classifier_cfg": {
            ...
            "load_doe_name": f"{merged_doe_name}.pt",  # 用于训练 merge team 的原始 doe cls，直接 load
            "mlp": {
                "hidden_sizes": [128],
                "batch_size": 512,
                "test_fraction": 0.1,
...
if __name__ == "__main__":
    ...
    # 指定本层merge的所有存储文件路径为：
    save_dir=f'{MEDoE_DIR}/doe_epymarl-main/results/gfootball/{Time}'
