...
if __name__ == "__main__":
    ...
    #             n_agents,
    #             group_id=merge_group_id_1, iter=0, suffix=suffix)
    ...
    save_dir=f'{MEDoE_DIR}/doe_epymarl-main/results/gfootball/{Time}/decomposition{response_id}/group{merge_group_id_1}'
    ...
    rl_runs = train_merge_team(child_tasks, use_doe, layer=merge_layer, decompose_id=response_id,
                               group_id=merge_group_id_1, iter_id=0, sample_id=response_r_id,
                               buffer_dir=save_dir,
